	...
	<ul>
		<li class="info_title">
			...
			foreach ($info as $val) {
				...
				echo "<span class='author'><a href='/index.php?r=log/detail&id=".$val['id']."'>".$val['uid']."</a></span>";
				echo "<span class='author'>".$val['content']."</span>";
				echo "<span class='date'>".date('Y-m-d H:i:s', $val['rectime'])."</span>";
				echo "<span class='oper'>";
				echo "<a href='/index.php?r=log/detail&id=".$val['id']."'>详情</a>&nbsp;";
				echo "</span>";
				echo "</li>";

...
<div class="info">
    <div class="info_add">
	    <?php 
			echo "<a href='/index.php?r=role/add'>添加角色</a>";
		?>
		<!-- <a href="/">添加功能</a> -->
	</div>
	<ul>
		<li class="info_title">
			...
			foreach ($info as $val) {
				...
				echo "<span class='author'><a href='/index.php?r=manager/detail&id=".$val['id']."'>".$val['name']."</a></span>";
				echo "<span class='author'></span>";
				echo "<span class='date'>".date('Y-m-d H:i:s', $val['addtime'])."</span>";
				echo "<span class='oper'>";
				echo "<a href=‘/index.php?r=role/edit&id=".$val['id']."'>分配权限</a>&nbsp;";
				echo "<a href='/index.php?r=role/detail&id=".$val['id']."'>查看权限</a>&nbsp;";
				echo "<a href='/index.php?r=role/del&id=".$val['id']."'>删除</a>&nbsp;";
				echo "</span>";
				echo "</li>";

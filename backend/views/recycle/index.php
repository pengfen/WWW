<style>
	...
	.info_content {
	    background: #f9f9f9; font-size: 14px; padding-left: 8px;
	}
	...
	<ul>
		<li class="info_title">
			...
			foreach ($info as $val) {
				...
				echo "<span class='author'><img src='".$val['image']."'/></span>";
				echo "<span class='date'>".date('Y-m-d H:i:s', $val['addtime'])."</span>";
				echo "<span class='oper'>";
				echo "<a href='/index.php?r=recycle/detail&id=".$val['id']."'>详情</a>&nbsp;";
				echo "<a href='/index.php?r=recycle/del&id=".$val['id']."'>删除</a>&nbsp;";
				echo "</span>";
				echo "</li>";
